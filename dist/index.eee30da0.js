...
},{}],"cvM4X":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
const newProduct = _objectHelpers.createProduct({
    id: 12,
    code: "d f g",
...
},{"./helpers/objectHelpers":"6NjJv"}],"6NjJv":[function(require,module,exports) {
...
function createProduct({ id , code , title  }) {
    return {
        id: id,
        code: _stringHelpers.makeUppercase(code),
        title: _stringHelpers.limitLength(12, _stringHelpers.replaceSpaces(title))
    };
}

},{"./stringHelpers":"e8WfW","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e8WfW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "makeUppercase", ()=>makeUppercase
);
parcelHelpers.export(exports, "replaceSpaces", ()=>replaceSpaces
);
parcelHelpers.export(exports, "limitLength", ()=>limitLength
);
...
},{}]},["kn9T2","cvM4X","5Mosj"], "5Mosj", "parcelRequire94c2")
